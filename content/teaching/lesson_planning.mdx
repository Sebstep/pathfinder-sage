...
For instance, if you want to use science-backed strategies like active learning, problem-based learning, retrieval practice, elaboration, or analogies, you can begin the conversation by asking for a summary of these approaches.[^Dunlosky2013LearningTechniques] [^Freeman2014ActiveLearning] [^RoedigerKarpicke2006TestingEffect] By [giving the model time to think](/prompting/chain-of-thought-prompting), this background step helps the AI understand what principles to embed in your lesson design. 
