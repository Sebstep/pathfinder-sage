...
<div className="chat-container">
  <div className="message user">
    ...
    <div className="message-bubble">Analyze this Data. […]</div>
  </div>
  <div className="message assistant">
    <div className="message-avatar">🤖</div>
    <div className="message-bubble">*[Unstructured and unhelpful response]*</div>
  </div>
</div>
...
<div className="chat-container">
  ...
  <div className="message assistant">
    <div className="message-avatar">🤖</div>
    <div className="message-bubble">*[Clear, audience-tailored response]*</div>
  </div>
</div>
