...
Instructive language is the key to achieving clear, actionable, and useful outputs. Unlike descriptive language, which merely provides information, <mark>instructive language guides the model step-by-step</mark>, ensuring it understands not just what the task is, but how to approach it.[^Lin2024EffectivePrompts]

## The Importance of Instructive Prompts

Generative AI models process instructions more effectively when they are framed as explicit actions. For example, instead of saying, "<span mark-color="red">This is an excerpt</span> discussing […]", an instructive prompt would say, "<span mark-color="green">Read the following excerpt</span> discussing…" This proactive phrasing eliminates ambiguity, directing the model to perform the task instead of simply recognizing the content.[^Liu2023PromptSurvey]
