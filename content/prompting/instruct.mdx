...
Instructive language is the key to achieving clear, actionable, and useful outputs. Unlike descriptive language, which merely provides information, <mark>instructive language guides the model step-by-step</mark>, ensuring it understands not just what the task is, but how to approach it.
