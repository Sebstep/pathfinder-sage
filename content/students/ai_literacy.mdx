...
AI models frequently generate plausible-looking citations — complete with author names, journal titles, volume numbers, and page ranges — that do not exist. Students who do not verify references can build academic work on fabricated foundations without knowing it.[^AlkaissiMcFarlane2023Hallucinations] This is not occasional; it is a systematic characteristic of how these models generate text.[^Huang2024Survey]
...
[^WaltersWilder2023Detecting]: Walters, W. H., & Wilder, E. I. (2023). **Discerning GPT-generated from human-written scholarly text**. *Scientific Reports*, *13*, 15047. https://doi.org/10.1038/s41598-023-41032-5
