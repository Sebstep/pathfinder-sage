...
<Callout type="warning">This article focuses on hallucinations and biases. If you are interested in the possible pitfalls related to **sharing sensible data in your prompts** and **potential copyright infringement**, check out the section on [when to use generative AI](/genai/when_to_use).</Callout>
...
- **Inappropriate Use Case**: Asking for insights on the latest research paper published this month or for predictions about ongoing political events. The model won’t have this information unless you include it in the prompt.
