...
<Callout type="warning">This article focuses on hallucinations and biases. If you are interested in the possible pitfalls related to **sharing sensible data in your prompts** and **potential copyright infringement**, check our the section on [when to use generative AI](/genai/when_to_use).</Callout>
