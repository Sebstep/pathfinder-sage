...
<Callout type="warning" emoji="️⏰">
  The Chain-of-Thought approach gained widespread popularity in January 2025, following the release of DeepSeek R1, a language model that excelled at reasoning through step-by-step thought processes. Soon after, other models, including OpenAI’s o1/o3 series, Anthropic’s Claude 3.7, and Google’s Gemini 2.0 Flash Thinking, adopted the technique to improve reasoning.
</Callout>
